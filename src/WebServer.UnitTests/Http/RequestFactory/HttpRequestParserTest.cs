...
using System.Linq;
using System.Text;
using WebServer.UnitTests.TestHelpers;

namespace WebServer.UnitTests.Http.RequestFactory
{
    [TestClass]
    public class HttpRequestParserTest
    {
        ...
        {
            var s = new Devkoes.Restup.WebServer.Http.RequestFactory.HttpRequestParser();
            ...
            Assert.AreEqual(RestVerb.GET, request.Method);
