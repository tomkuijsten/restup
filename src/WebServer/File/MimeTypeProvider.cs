...
namespace Restup.Webserver.File
{
    ...
    {
        public static IReadOnlyDictionary<string, string> DefaultMimeTypesByExtension { get; } = new Dictionary<string, string>
        {
            { ".3dm", "x-world/x-3dmf" },
            { ".3dmf", "x-world/x-3dmf" },
        ...
        private readonly IDictionary<string, string> mimeTypesByExtension;
